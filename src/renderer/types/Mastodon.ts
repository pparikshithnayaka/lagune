...
export interface GetAccountFollowersOptions {
...
export interface GetAccountFollowingOptions {
  /** Get a list of followers with ID less than this value */
  max_id?: number;
  /** Get a list of followers with ID greater than this value */
  since_id?: number;
...
export interface GetAccountStatusesOptions {
...
export interface MuteAccountOptions {
  /** Determines whether the mute will mute notifications or not. Default(true) */
  notifications: true;
}

export interface GetAccountRelationshipsOptions {
...
export interface GetDomainBlocksOptions {
  /** Get a list of blocks with ID less than this value */
  max_id?: string;
  /** Get a list of blocks with ID greater than this value */
  since_id?: string;
...
export interface GetFavouritesOptions {
...
export interface GetFollowRequestsOptions {
...
export interface GetMutesOptions {
...
export interface GetNotifications {
  ...
  exclude_types?: ('follow'|'favourite'|'reblog'|'mantions')[];
}
...
export interface GetWhoRebloggedOptions {
...
export interface GetWhoFavouritedOptions {
  /** Get a list of reblogged/favourited with ID less than this value */
  max_id?: string;
  /** Get a list of reblogged/favourited with ID greater than this value */
  since_id?: string;
